...
const Courses = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const [chaptersRes, progressRes, materialsRes] = await Promise.all([
        supabase
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                <div className="relative">
                  ...
                  <Input
                    placeholder={activeTab === "courses" ? "搜索课程..." : "搜索资料名称、描述或标签..."}
                    value={searchQuery}
        ...
        <TabsContent value="courses" className="space-y-6 mt-4">
          ...
          {Object.keys(filteredGroupedChapters).length === 0 ? (
            ...
            Object.entries(filteredGroupedChapters).map(([category, categoryChapters]) => (
